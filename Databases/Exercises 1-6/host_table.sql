...
SELECT host_id as id, host_url as url, host_name as name, host_since as since, host_location as location, host_about as about,
host_response_time as response_time, host_response_rate as respone_rate, host_acceptance_rate as acceptance_rate, host_is_superhost as is_superhost,
